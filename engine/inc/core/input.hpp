...
public:
    ...
    [[nodiscard]] bool IsGamepadAvailable(int gamepadID) const;

    /// Returns the current floating-point value of a given gamepad axis.
    [[nodiscard]] float GetGamepadAxis(int gamepadID, EGamepadAxis axis) const;
