...
Apex::GeomPass::GeomPass()
{
    ...
    m_opaque_shader = Swift::GraphicsShaderBuilder(context)
                      ...
                      .SetMeshShader(geom_opaque_mesh_main_code)
                      .SetPixelShader(geom_opaque_pixel_main_code)
    ...
    m_translucent_shader = Swift::GraphicsShaderBuilder(context)
                           ...
                           .SetDSVFormat(Swift::Format::eD32F)
                           .SetMeshShader(geom_transparent_mesh_main_code)
                           .SetPixelShader(geom_transparent_pixel_main_code)
                           .SetDepthTestEnable(true)
